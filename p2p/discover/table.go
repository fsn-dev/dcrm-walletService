...
const (
	...
	// IP address limits.
	bucketIPLimit, bucketSubnet = 10, 24 // at most 2 addresses from the same /24
	tableIPLimit, tableSubnet   = 30, 24
...
type transport interface {
	...
	sendToGroupCC(toid NodeID, toaddr *net.UDPAddr, msg string, p2pType int) error
	close()
}
